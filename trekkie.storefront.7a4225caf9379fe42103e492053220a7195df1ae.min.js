    ...
    var e = {
        ...
        3249: function(e, t, n) {
            ...
            t.updateTrackingConsent = function(e, t, n) {
                ...
                i.onreadystatechange = function() {
                    ...
                    var s;
                    0 === (s = i.status) || 200 >= s && s < 400 ? (r.dispatchEvents(e, n),
                    t(null, a)) : t(a)
                }
                ,
                i.send(a)
        ...
        5841: function(e, t, n) {
            ...
            function l(e) {
                if (e == o.ConsentSignal.GPC)
                    return r.consentMethods.isGPCSignalPresent() ? r.consentMethods.isGPCOptOutPresent() ? o.ConsentValuesV2.DECLINED : o.ConsentValuesV2.ACCEPTED : o.ConsentValuesV2.NO_VALUE;
                const t = u();
                if (!t)
                    return o.ConsentValuesV2.NO_VALUE;
                const n = t.con.CMP;
            ...
            t.setHeadlessTrackingConsent = function(e, t) {
                ...
                a.writeCookie(s, e.rootDomain, 31536e6, i),
                t(null)
            }
            ,
        ...
        8920: function(e, t, n) {
            ...
            function p() {
                if (i.validCookieDoesNotExist())
                    return r.ConsentValuesV1.NO_VALUE;
            ...
            function E() {
                const e = d();
                if (e === r.TrackingRegulations.NO_VALUE)
                    return !1;
                const t = l();
            ...
            function A() {
                return T() ? r.ConsentValuesV1.DECLINED : (e = i.getCCPAConsentValue(),
                i.validCookieDoesNotExist() ? r.ConsentValuesV1.NO_VALUE : e === r.ConsentValuesV2.NO_VALUE ? r.ConsentValuesV1.NO_INTERACTION : i.transformConsentToDisplaySchema(e));
                var e
            }
            function I(e) {
                if (!y())
                    ...
                    if (function(e) {
                        if (S()) {
                            ...
                            if ("object" == typeof e) {
                                ...
                                for (const e of t)
                                    if (!n.includes(e))
                                        throw TypeError(`The submitted consent object should only contain the following keys: ${n.join(", ")}.`)
                            }
        ...
        1449: function(e, t) {
            ...
            t.writeCookie = function(e, t, o, r) {
                ...
                i += "; path=/",
                i += `; domain=${t}`,
                i += `; expires=${new Date((new Date).getTime() + o).toUTCString()}`,
                i += "; secure",
                document.cookie = i,
                n[e] = r
            }
        ...
        5814: function(e, t, n) {
            ...
            function a(e) {
                !0 === e[o.DataProcessingPurpose.FIRST_PARTY_MARKETING] ? i(o.TrackingEvents.FIRST_PARTY_MARKETING_ACCEPTED) : !1 === e[o.DataProcessingPurpose.FIRST_PARTY_MARKETING] && i(o.TrackingEvents.FIRST_PARTY_MARKETING_DECLINED),
                !0 === e[o.DataProcessingPurpose.THIRD_PARTY_MARKETING] ? i(o.TrackingEvents.THIRD_PARTY_MARKETING_ACCEPTED) : !1 === e[o.DataProcessingPurpose.THIRD_PARTY_MARKETING] && i(o.TrackingEvents.THIRD_PARTY_MARKETING_DECLINED),
                !0 === e[o.DataProcessingPurpose.ANALYTICS] ? i(o.TrackingEvents.ANALYTICS_ACCEPTED) : !1 === e[o.DataProcessingPurpose.ANALYTICS] && i(o.TrackingEvents.ANALYTICS_DECLINED),
                !0 === e[o.DataProcessingPurpose.PREFERENCES] ? i(o.TrackingEvents.PREFERENCES_ACCEPTED) : !1 === e[o.DataProcessingPurpose.PREFERENCES] && i(o.TrackingEvents.PREFERENCES_DECLINED);
                const t = function(e) {
                    return {
            ...
            t.dispatchEvents = function(e, t) {
                void 0 !== e.consent ? (!0 === e.consent ? i(o.TrackingEvents.TRACKING_ACCEPTED) : i(o.TrackingEvents.TRACKING_DECLINED),
                t && a({
        ...
        5461: function(e, t, n) {
            ...
            function k() {
                const e = {};
                if (t = o.TrackingRegulationLimitations.GDPR_BLOCK_ALL,
                f().limit.includes(t) && I()) {
                    const t = a.getCMPConsentValues();
                    for (const n of Object.keys(t))
                        e[a.transformKeyToDisplayName(n)] = a.transformConsentToDisplaySchema(t[n])
                }
                var t;
                return e
            }
        ...
        6304: function(e, t) {
            ...
            (n = t.TrackingEvents || (t.TrackingEvents = {})).TRACKING_ACCEPTED = "trackingConsentAccepted",
            ...
            (r = t.ConsentValuesV1 || (t.ConsentValuesV1 = {})).ACCEPTED = "yes",
            r.DECLINED = "no",
            ...
            (a = t.TrackingRegulations || (t.TrackingRegulations = {})).GDPR = "GDPR",
            a.CCPA = "CCPA",
            a.NO_VALUE = "",
            t.DataProcessingPurpose = void 0,
            (s = t.DataProcessingPurpose || (t.DataProcessingPurpose = {})).PREFERENCES = "p",
            s.ANALYTICS = "a",
            s.FIRST_PARTY_MARKETING = "m",
            s.THIRD_PARTY_MARKETING = "t",
            t.TrackingRegulationLimitations = void 0,
            (c = t.TrackingRegulationLimitations || (t.TrackingRegulationLimitations = {})).CCPA_BLOCK_ALL = "CCPA_BLOCK_ALL",
            c.GDPR = "GDPR",
            c.GDPR_BLOCK_ALL = "GDPR_BLOCK_ALL",
            c.CCPA = "CCPA",
            t.CmpV2_1ConsentKeys = void 0,
            (u = t.CmpV2_1ConsentKeys || (t.CmpV2_1ConsentKeys = {})).MARKETING = "m",
            u.ANALYTICS = "a",
            u.PREFERENCES = "p",
            u.GPC = "g",
            u.SALE_OF_DATA = "s",
            ...
            (d = t.CmpV2_1ConsentDisplayKeys || (t.CmpV2_1ConsentDisplayKeys = {})).MARKETING = "marketing",
        ...
        7385: function(e, t, n) {
            ...
            var l = function(e) {
                ...
                n.prototype.ensureTrackingConsent = function(e, t) {
                    c.isMerchantOnGranularConsentBeta() || (c.isLegacyGdprEnforced() ? (document.addEventListener(d.TRACKING_ACCEPTED, e),
                    t()) : e())
                }
                ,
        ...
        1930: function(e, t) {
            ...
            t.extractSchemaIdFromEventName = t.buyWithPrimePresenceSchemaId = t.trekkieAssetContextSchemaId = t.customStorefrontAnalyticsSchemaId = t.storefrontAnalyticsSchemaIdValidation = t.storefrontAnalyticsSchemaId = t.appNameToEcommerceEventSchemaId = t.appNameToPageViewSchemaId = void 0,
        ...
        8523: function(e, t) {
            ...
            (n = t.ConsentPurposes || (t.ConsentPurposes = {})).FIRST_PARTY_MARKETING = "m",
            ...
            var a = n(7385)
              ...
              , f = function(e) {
                function t(n, o) {
                    ...
                    return r.campaignManager = new l.CampaignManager,
                    r
                }
                return r(t, e),
                ...
                t.prototype.initialize = function(e) {
                    ...
                    for (var t = this.options, n = 0, o = this.getFacebookPixelIds(t); n < o.length; n++) {
                        ...
                        d.default.isEnabled(d.ENABLE_FB_PIXEL_DISABLE_PUSH_STATE_BETA_FLAG) && (window.fbq.disablePushState = !0),
                        window.fbq("init", r),
            ...
            var i = n(7385)
              ...
              , p = function(e) {
                ...
                t.prototype.initialize = function(e) {
                    ...
                    this.setPixelStub(),
                    this.loadGtagScript(),
                    s.userDataCannotBeSold() && (n.restricted_data_processing = !0),
                    t.ignoreReferrer && (window.gtag("set", {
        ...
        3653: function(e, t, n) {
            ...
            var v = function(e) {
                function n(t, o) {
                    ...
                    return r.pageID = _.default.microSessionId,
                    r
                }
                return r(n, e),
                ...
                n.prototype.completedOrder = function(e) {
                    ...
                    (null === (n = e.s2sMetadata) || void 0 === n ? void 0 : n.serverEventId) && (r.server_event_id = e.s2sMetadata.serverEventId),
                    this.produceToMonorail({
        ...
        6971: function(e, t, n) {
            ...
            var a = n(7385)
              ...
              , p = function(e) {
                ...
                ,
                t.prototype.completedOrder = function(e) {
                    var t, n = e.properties, o = c.objectAssignFilterUndefined({
              ...
              , u = function(e) {
                ...
                t.prototype.setPixelStub = function() {
                    if (!window.ttq || !window.ttq.loaded) {
                        ...
                        e.instance = function(t) {
                            for (var n = e._i[t] || [], o = 0; o < e.methods.length; o++)
                ...
                t.prototype.loadTikTokScript = function(e) {
                    ...
                    t.load = function(e) {
                        ...
                        void 0 === r ? document.head.appendChild(o) : r.parentNode.insertBefore(o, r),
                        window.ttq.loaded = !0
                    }
                    ,
                    t.load(e)
                ...
                t.prototype.emitEvent = function(e, t, n, o, r) {
                    void 0 === r && (r = {}),
                    window.ttq.instance(e).track(t, r, {
                        event_id: n
                    }),
                    this.addMonorailBatchEvent(c.objectAssignFilterUndefined({
                        eventName: o
        ...
        9115: function(e, t) {
            ...
            t.ENABLE_FB_PIXEL_DISABLE_PUSH_STATE_BETA_FLAG = t.DEFAULT_TO_ORDER_ID_BETA_FLAG = void 0,
            t.DEFAULT_TO_ORDER_ID_BETA_FLAG = "defaultToOrderId",
            t.ENABLE_FB_PIXEL_DISABLE_PUSH_STATE_BETA_FLAG = "enableFbPixelDisablePushState";
            var n = function() {
                function e() {
                    this.betaFlagsProps = []
                }
        ...
        6997: function(e, t, n) {
            ...
            var o, r, i = n(1503), a = n(542), s = n(2724), c = n(7662), u = n(7668), p = n(725), d = n(1102), l = "myshopify.com", f = [l, "spin.dev"], _ = "_shopify_d", g = new Date(0);
            function v(e) {
            ...
            t.cookieImpl = {
                ...
                write: function(e, n, o) {
                    ...
                    t.cookieImpl.enabled() && t.cookieImpl.allowed(e)) {
                        ...
                        (o.maxage < 0 || o.expires && c.isLegacyGdprNotEnforced()) && (r += "; expires=" + o.expires.toUTCString()),
                ...
                enabled: function(e) {
                    ...
                    !e && void 0 !== r)
                        return r;
                    try {
                        if (void 0 === i.virtualDocument().cookie())
                            return !1;
                        var t = "cookietest";
                        i.virtualDocument().setCookie(t + "=1; SameSite=Lax");
                        var n = -1 !== i.virtualDocument().cookie().indexOf(t + "=");
                        return i.virtualDocument().setCookie(t + "=1; expires=Thu, 01-Jan-1970 00:00:01 GMT; SameSite=Lax"),
                        n && (r = n),
                        n
                    } catch (e) {
                        return !1
        ...
        7662: function(e, t, n) {
            ...
            t.haveConsentForIntegration = function(e) {
                ...
                for (var t = 0, n = e.integrationPurposes(); t < n.length; t++) {
                    var o = n[t];
                    if (!this.haveConsentForPurpose(o))
                        return !1
                }
                return !0
            }
        ...
        2971: function(e, t, n) {
            ...
            var o, r, i = n(997), a = n(725), s = n(1102);
            ...
            t.sendToBugsnag = function(e) {
                ...
                if (this.shouldSendToBugsnag()) {
                    ...
                    if (e.stack) {
                        ...
                        if (p && p.length > 2 && (c.lineNumber = p[1],
                        c.columnNumber = p[2],
            ...
            var a = "xxxx-4xxx-xxxx-xxxxxxxxxxxx"
              , s = function() {
                ...
                return e.prototype.fetchOrSet = function(e, t, n) {
                    ...
                    o || (o = c(),
                    a = !0,
                    n && !this.isCookieSetServerSideEventFired && (i.logMetricToMonorail("serverSideCookieNotSet_" + t),
            ...
            var r = n(8831)
              ...
              , C = function() {
                function e(e, t, n) {
                    ...
                    c.logMetricToMonorail("navigation-" + (null === (o = this.navigationInfo) || void 0 === o ? void 0 : o.navigationApi) + "-" + (null === (r = this.navigationInfo) || void 0 === r ? void 0 : r.navigationType)),
                    ...
                    p.isModernGdprEnforced()) {
                        var a = function() {
                            ...
                            i.initialize(e, t, n),
                            document.removeEventListener(p.TrackingEvents.TRACKING_ACCEPTED, a)
                        };
                        document.addEventListener(p.TrackingEvents.TRACKING_ACCEPTED, a),
                        s.flushBatchEvents()
                    } else
                ...
                e.prototype.getNavigationType = function() {
                    try {
                        ...
                        return t || (t = _.getNavigationTypeLegacy(),
                ...
                e.prototype.getS2SEventId = function(e, t, n) {
                    ...
                    try {
                        if ("product_added_to_cart" === s && (null === (o = window.Shopify) || void 0 === o ? void 0 : o.evids)) {
                            ...
                            i = (null === (r = window.Shopify) || void 0 === r ? void 0 : r.evids) && s ? window.Shopify.evids(s, {
                                analyticsFramework: "trekkie"
                            }) : d.buildToken()
                    } catch (e) {
                        i = d.buildToken()
                ...
                e.prototype.loadIntegrations = function(e, t, n) {
                    ...
                    if (p.isMerchantOnGranularConsentBeta()) {
                        ...
                        for (var i = 0, a = e; i < a.length; i++) {
                            ...
                            try {
                                if ((v = t[g = s[0]]) && "object" == typeof v) {
                                    ...
                                    p.haveConsentForIntegration(u) ? d ? u.initialize(r) : r() : (m[g] = [d, u, []],
                                    r())
                                } else
                                    r()
                            } catch (e) {
                                r(),
                                c.reportError("loadIntegration", e)
                            }
                        }
                        ...
                        for (var l = 0, _ = e; l < _.length; l++) {
                            ...
                            try {
                                var g, v;
                                (v = t[g = s[0]]) && "object" == typeof v ? (u = new (0,
                                s[1])(v,r),
                                this.integrations.push(u)) : r()
                            } catch (e) {
                                r(),
                                c.reportError("loadIntegration", e)
                            }
                ...
                e.prototype.page = function(e, t, n) {
                    ...
                    if (p.isMerchantOnGranularConsentBeta())
                        for (var i = 0, a = this.integrations; i < a.length; i++) {
                            var s = a[i];
                            try {
                                if (p.haveConsentForIntegration(s))
                                    s.page(r);
                                else {
                                    var u = s.name()
                                      , d = m[u][2]
                        ...
                        for (var f = function(e) {
                            try {
                                if (_.canEmitEvent(e))
                                    ...
                                    var t = function() {
                                        e.page(r),
                                        document.removeEventListener(p.TrackingEvents.TRACKING_ACCEPTED, t)
                                    };
                        ...
                        }, _ = this, g = 0, v = this.integrations; g < v.length; g++)
                            f(s = v[g]);
                ...
                e.prototype.track = function(e, t, n) {
                    ...
                    if (p.isMerchantOnGranularConsentBeta())
                        for (var a = 0, s = this.integrations; a < s.length; a++) {
                            var u = s[a];
                            try {
                                if (p.haveConsentForIntegration(u))
                                    u.track(i);
                                else {
                                    var d = u.name()
                                      , l = m[d][2]
                        ...
                        }, g = this, v = 0, h = this.integrations; v < h.length; v++)
                            _(u = h[v]);
                    return this.flushMonorailEventsIfLoaded(),
                    r.eventId
                }
                ...
                e.prototype.generatePageObject = function(e, t, n, o) {
                    var r = a.href()
                      , s = r.indexOf("?");
                    return s = (r = -1 === s ? "" : r.slice(s)).indexOf("#"),
                ...
                e.prototype.url = function() {
                    var e = g.canonical();
                    if (e)
                        return e.indexOf("?") > 0 ? e : e + a.search();
                    var t = a.href()
                      , n = t.indexOf("#");
                ...
                e.prototype.setupGranularConsentEventListener = function(e) {
                    Object.keys(e).length > 0 && (this.defList = this.consentCollectedListener.bind(this),
                    document.addEventListener(p.TrackingEvents.CONSENT_COLLECTED, this.defList))
                }
                ,
        ...
        803: function(e, t, n) {
            ...
            function S() {
                ...
                e.Shopify.evids = (e,t)=>function(e, t) {
                    if (!P[e] || (null == t ? void 0 : t.analyticsFramework) !== T && (null == t ? void 0 : t.analyticsFramework) !== C)
                        return I(r);
